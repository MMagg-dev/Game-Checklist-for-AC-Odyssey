...
Mahak Aggarwal ("MMagg", "je", "moi", "notre") a créé Game Checklist, Tracker and Guide - for AC Odyssey en tant qu'application mobile financée par la publicité. Ce service est fourni par moi à titre gracieux et est destiné à être utilisé tel quel. Cette politique de confidentialité contient des informations sur la collecte, l'utilisation et la divulgation d'informations personnelles en cas d'utilisation du service ("app", "application").  
